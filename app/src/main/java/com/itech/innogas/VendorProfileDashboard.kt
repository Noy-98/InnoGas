...
class VendorProfileDashboard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_vendor_profile_dashboard)
        ...
        editProfileButton.setOnClickListener {
            val intent = Intent(this, VendorEditProfileDashboard::class.java)
            startActivity(intent)
        }
    }
        ...
        if (currentUser != null){
            ...
            usersReference.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (snapshot.exists()) {
                        ...
                        if (users != null) {
                            ...
                            Glide.with(this@VendorProfileDashboard)
                ...
                override fun onCancelled(error: DatabaseError) {
                    Toast.makeText(this@VendorProfileDashboard, "Failed to load profile", Toast.LENGTH_SHORT).show()
                }
