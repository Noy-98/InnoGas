...
class ProductsAdapter2(private val context: Context, private var productList: List<ProductsDBStructure>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.viewDetailsBttn.setOnClickListener {
            ...
            val intent = Intent(context, CustomerViewDetailsDashboard::class.java)
